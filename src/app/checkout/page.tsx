  ...
  if (step === "confirmed") {
    return (
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-24 text-center gap-6">
        ...
        {/* WhatsApp CTA — direct link, no popup prompt */}
        {whatsappUrl && (
          <a
            href={whatsappUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 bg-[#25d366] text-white rounded-full px-8 py-4 font-body font-bold text-[16px] hover:brightness-95 active:scale-95 transition-all shadow-raised"
          >
